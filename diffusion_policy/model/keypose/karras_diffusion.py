...
from diffusion_policy.model.consistency.nn import mean_flat, append_dims, append_zero
from diffusion_policy.model.consistency.random_util import get_generator
...
class KarrasDenoiser:
    ...
    def consistency_losses(
        ...
        term = {}
        term["diffs"] = diffs  # [B, 1, 14]
        term["weights"] = weights #[B]
