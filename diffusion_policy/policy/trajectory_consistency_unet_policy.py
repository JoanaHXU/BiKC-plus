...
from diffusion_policy.model.diffusion.goal_conditional_unet1d import GoalConditionalUnet1D
...
class TrajectoryConsistencyUnetPolicy(TrajectoryBasePolicy):
    def __init__(self, 
            shape_meta: dict,
    ...
    def predict_trajectory(self,
        ...
        nkeypose = self.normalizer['keypose'].normalize(keypose)
    ...
    def compute_loss(self, batch, global_step):
        ...
        nkeypose = self.normalizer['keypose'].normalize(batch['keypose'])
