...
from diffusion_policy.policy.trajectory_consistency_unet_policy import TrajectoryConsistencyUnetPolicy
import ipdb

OmegaConf.register_new_resolver("eval", eval, replace=True)

class TrainTrajectoryConsistencyUnetWorkspaceDDP(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: TrajectoryConsistencyUnetPolicy
        self.model = hydra.utils.instantiate(cfg.policy)

        self.ema_model: TrajectoryConsistencyUnetPolicy = None
    ...
    def run(self):
        ...
        device = ddp_info["gpu"]  # local rank
        ...
        self.optimizer = hydra.utils.instantiate(
            cfg.optimizer, params=ddp_model.parameters())
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tepoch:
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        loss = ddp_model(batch, self.global_step)
                        loss.backward()
                ...
                # ========= eval for this epoch ==========
                policy = ddp_model.module
                if cfg.training.use_ema:
                    policy = ddp_ema_model.module
                policy.eval()
...
def main(cfg):
    workspace = TrainTrajectoryConsistencyUnetWorkspaceDDP(cfg)
    workspace.run()
