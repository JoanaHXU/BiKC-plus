...
class TrainTrajectoryConsistencyUnetWorkspace(BaseWorkspace):
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if (self.epoch % cfg.training.sample_every) == 0:
                    with torch.no_grad():
                        ...
                        obs_dict = batch['obs']
                        keypose = batch['keypose']
                        gt_action = batch['action']
                        
                        result = policy.predict_trajectory(obs_dict, keypose)
...
def main(cfg):
    workspace = TrainTrajectoryConsistencyUnetWorkspace(cfg)
    workspace.run()
