...
'''
DIST_MIN_transfer = 50 ## 1s
WINDOW_SIZE_transfer = 5 ## smoothing window size
...
def _find_keypose_idx_transfer(
    ...
    gripper = _smooth(gripper, window_size=window_size, visualize=False)
    ee_vel = _smooth(ee_vel, window_size=5, visualize=False)
