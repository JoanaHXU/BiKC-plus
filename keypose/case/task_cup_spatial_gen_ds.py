...
task_name = 'aloha2_cup_spatial'
num_episodes = 50

keypose_ds_dir = f'/home/xuhang/TASE/kp_dataset/{task_name}/dataset_keypose/' 
demo_ds_dir = f'/ssd1/xuhang/datasets/{task_name}/'
output_dir = f'/ssd1/xuhang/datasets/{task_name}/keypose/'
