...
keypose_ds_dir = '/home/xuhang/TASE/kp_dataset/aloha2_cup_temporal/dataset_keypose/' 
demo_ds_dir = '/ssd1/xuhang/datasets/aloha2_cup_temporal/'
output_dir = '/ssd1/xuhang/datasets/aloha2_cup_temporal/keypose/'
num_episodes = 50
